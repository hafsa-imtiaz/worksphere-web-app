...
function initializeFocusTimer() {
    ...
    const decreaseBtn = document.querySelector('.notification-time .timer-btn:first-child');
    const increaseBtn = document.querySelector('.notification-time .timer-btn:last-child');
